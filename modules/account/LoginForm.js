...
class LoginForm extends Component{
    ...
    render() {
        return <React.Fragment>
            ...
            <Modal isOpen={this.state.forgotShow} toggle={e=>this.toggle(e)} className="modal-dialog">
                <ModalBody>
                        ...
                        <div id="forgotModal" className="forgot-content">
                            ...
                            <div className="forgot-form">
                                <form id="forgotPassword"action="/customers/reset" method="post" onSubmit={e=>this.forgot(e)}>
                                    ...
                                    <div className="field submit"><a href="/"   onClick={e=>this.toggle(e)}  className="back-to-login">Back</a><input type="submit" value="Send" /></div>
